...
const wstr msg_table[] = {
	...
	L"Could't get time information of the file or directory \"%1%\".",
	L"Could't set time information of the file or directory \"%1%\".",
	L"Could't get reparse information of the file \"%1%\".",
	L"Could't set reparse information of the file \"%1%\".",
